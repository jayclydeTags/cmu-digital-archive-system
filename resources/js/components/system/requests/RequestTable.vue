    ...
    <div>
        ...
        <v-card flat class="rounded-lg">
            ...
            <v-data-table
                ...
                <template v-slot:top>
                    <v-toolbar flat>
                        <v-toolbar-title>List of Client Requests</v-toolbar-title>
                                ...
                                <!-- <v-card-text> -->
                                    <v-container>
                                        <v-alert text type="info" class="text-body-2">
                                            Review first the attached file of the request before approving the request.
                                        </v-alert>
                                        <v-form ref="form" @submit.prevent="save" v-model="rules.isValid"
                                            lazy-validation>
                                            <!-- <v-row>
                                                <v-col cols="12"> -->
                                                    <v-textarea v-model="form.purpose" label="Purpose"  disabled
                                                        filled name="input-7-4" required></v-textarea>
                                                <!-- </v-col>

                                                <v-col cols="12"> -->
                                                    <v-select v-model="form.status" :items="selectItem"
                        ...
                        <v-row justify="center">
                            <v-dialog v-model="viewdialog" fullscreen hide-overlay
                                ...
                                <v-card>
                                    ...
                                    <div v-if="getRequestForm" class="text-center">
                                        <embed :src="getRequestForm.filecontent" v-show="
                ...
                <template v-slot:item.actions="{ item }">
                    ...
                    <v-btn-toggle v-model="icon" borderless>
                        <v-btn small value="left" color="info" class="ma-1 rounded-sm" @click="editItem(item)">
                            <v-icon small class="text-white"> mdi-pencil </v-icon>
                        </v-btn>
                        ...
                        <v-btn value="center" small color="success" class="ma-1 rounded-sm" @click="showRequestForm(item)"
                            v-show="item.status === 'Pending'">
                            <v-icon small class="text-white"> mdi-file </v-icon>
                        </v-btn>
                    </v-btn-toggle>
