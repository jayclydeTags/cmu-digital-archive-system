<template>
    <div>
        ...
        <v-card flat class="rounded-lg">
            ...
            <!-- User Table -->
            <v-data-table :headers="headers" :items="fetchCategory" :search="search" :loading="isLoading"
                            ...
                            <v-card>
                                ...
                                <v-container>
                                    <v-form ref="form" @submit.prevent="save" v-model="rules.isValid" lazy-validation>
                                        <v-row>
                                            <v-col cols="12">
                                                <v-text-field v-model="form.category" label="Name"
                            ...
                            <v-card>
                                ...
                                <v-container>
                                    <v-alert text type="error">
                                        You are about to delete this catergory. It might cause some problem to the
                                        records related to this category.
                                    </v-alert>
