        ...
        <v-row>
            <v-col cols="9" sm="6">
                <div v-if="documentid === 'requestreports'">
                    <v-select :items="items" v-model="period" @change="onChangePeriod">
                    </v-select>
                </div>

                <div v-else>
                    <v-select :items="uploadperioditems" v-model="uploadperiod" @change="onChangePeriodUploads"
                        >
                    </v-select>
                </div>
            </v-col>

            <v-col cols="3" sm="6" id="buttons">
                <div class="d-flex justify-content-end">
                    <v-btn-toggle v-model="icon" borderless>
                        <v-btn value="center" color="success" tile @click="printRequestReport">
