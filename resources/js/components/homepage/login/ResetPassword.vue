        ...
        <div>
            <v-layout row justify-center align-center>
                <v-card max-width="768" flat class="grey lighten-4">
                    ...
                    <v-card-text>
                        <h3 class="text-h5 font-weight-bold text-uppercase grey--text text--darken-4">Password Reset
                        </h3>
                        <p class="text-body-2">
                            Please enter your
                            new password.
                            ...
                            <v-form ref="form" @submit.prevent="save" v-model="rules.isValid" lazy-validation>
                                ...
                                <v-row>
                                    <v-col cols="12" class="px-0">
                                        <v-text-field label="New Password" v-model="form.password"
                                    ...
                                    <v-col cols="12" class="my-n6 px-0">
                                        <v-text-field label="Confirm New Password" v-model="form.password_confirmation"
                    ...
                    <v-card-actions class="px-4">
                        <v-row>
                            <v-col cols="12" lg="6">
                                <v-btn :disabled="!rules.isValid"
                                    class="grey darken-4 text-button grey--text text--lighten-5" @click="save">
                                    Reset
                                </v-btn>
                    ...
                    <v-card-text>
                        ...
                        <v-container>
                            <v-form ref="form" @submit.prevent="save" v-model="rules.isValid" lazy-validation>
                                ...
                                <v-row class="mt-n6">
                                    <v-col cols="12">
                                        <v-text-field label="New Password" v-model="form.password" outlined dense
                                            prepend-inner-icon="mdi-lock"
                                            :append-icon="showpass ? 'mdi-eye' : 'mdi-eye-off'"
                                            :type="showpass ? 'text' : 'password'" @click:append="showpass = !showpass"
                                            :rules="rules.password" required>
                                ...
                                <v-row class="mt-n6">
                                    <v-col cols="12">
                                        <v-text-field label="Confirm New Password" v-model="form.password_confirmation"
                                            outlined dense prepend-inner-icon="mdi-lock" :append-icon="
                                                showconfirmpass ? 'mdi-eye' : 'mdi-eye-off'
                                            " :type="showconfirmpass ? 'text' : 'password'"
                                            @click:append="showconfirmpass = !showconfirmpass"
                                            :rules="rules.password_confirmation" required>
                    ...
                    <v-card-actions>
                        <v-row>
                            <v-col cols="12" md="6" sm="8">
                                <v-btn x-large :disabled="!rules.isValid" color="info" dark @click="save">
                                    Reset
                                </v-btn>
